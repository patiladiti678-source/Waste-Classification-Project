...
💾 Saved Model
The trained model is saved at: MyDrive/waste_project/waste_classifier.h5

📘 Notebook
The full implementation is available in the notebook: Waste_Classification_Project.ipynb
